...
import { generateMemoOutsideProject1, generateMemoOutsideProject2, generateAnexoAOutsideProject,generateAnexo8 } from "../utils/generatorDocuments/event/internationalEventDocuments.js";
...
function ExternalInternationalEventsForm() {
  ...
  const handleGeneratePdf2 = () => {
    const formEventOutsideProject = methods.getValues();
    generateAnexo8(formEventOutsideProject);
    setShowDownloadSection(false);
  };
...
export default ExternalInternationalEventsForm;
